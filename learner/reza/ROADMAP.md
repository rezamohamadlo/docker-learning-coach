...
Learner: Reza
Start date (Jalali): Not set
Timezone: Asia/Tehran
Language: English
Suggested duration: eight weeks, adjustable
OS / shell / Docker context / versions: Not recorded
...
Schedule: Unknown — dates and due outcomes have not been agreed.
...
- [ ] P0-environment: Client, engine, and context — Not started
- [ ] P0-shell-and-setup: Shell and installation readiness — Not started

### Build

- [ ] Verify client, server, context and Compose using Lab 00. — Not started
...
Dates remain unset until the first session. Review work takes precedence over adding more new material when time is short.

| Week | Proposed outcome | Due date (Jalali) | Actual evidence | Gap / next action |
|---|---|---|---|---|
| 1 | Environment verified; image/container distinction introduced | Not scheduled | None | Begin Phase 0 |
| 2 | Lifecycle and ports demonstrated | Not scheduled | None | Lab 01 in daily slices |
| 3 | Dockerfile build and cache demonstrated | Not scheduled | None | Lab 02 in daily slices |
| 4 | Storage persistence and bind mounts demonstrated | Not scheduled | None | Lab 03 persistence slices |
| 5 | Network names and runtime config demonstrated | Not scheduled | None | Lab 04 and phase review |
| 6 | Compose, readiness and persistence demonstrated | Not scheduled | None | Lab 05 in daily slices |
| 7 | Diagnose failures; restore data; begin capstone | Not scheduled | None | Lab 03 restore plus design |
| 8 | Capstone runtime evidence and cumulative review | Not scheduled | None | Independent defense |
...
No lab resources created. Start by recording OS, shell and the intended Docker engine.
